...
const Untitled2 = () => {
  return <SafeAreaView style={styles.safeArea}>
      ...
      position: 'relative',
      flex: 1
    }}><View style={styles.CDiLulhP}></View><Text style={styles.yhmzDxfR}>Lorem ipsum…</Text><ImageBackground style={styles.OVLJSZyo} source={{
      ...
      }} resizeMode="cover"></ImageBackground><TextInput style={styles.YLLglkjx}></TextInput></ScrollView>
    </SafeAreaView>;
};
